...
export class TableLayoutFormFactory extends FormFactoryBase<TableLayoutExtraOptions> {
    protected renderField(name: string, field: React.ReactElement, fieldConfig: FieldConfig, configuration: FormOptions<TableLayoutExtraOptions>, index: number, fieldsCount: number): React.ReactElement {
